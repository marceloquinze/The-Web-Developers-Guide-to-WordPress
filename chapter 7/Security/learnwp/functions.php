...
function learnwp_config(){
   register_nav_menus(
      array(
        'learnwp_main_menu'   => esc_html__( 'Learn WP Main Menu', 'learnwp' ),
        'learnwp_footer_menu' => esc_html__( 'Learn WP Footer Menu', 'learnwp' ),
      )
   );	
...
function learnwp_sidebars(){
   register_sidebar( array(
      'name'          => esc_html__( 'Learn WP Main Sidebar', 'learnwp' ),
      'id'            => 'learn-wp-sidebar-1',
      'description'   => esc_html__( 'Drag and drop your widgets here', 'learnwp' ),
   ...
   register_sidebar( array(
      'name'          => esc_html__( 'Footer Sidebar 1', 'learnwp' ),
   ...
   register_sidebar( array(
      'name'          => esc_html__( 'Footer Sidebar 2', 'learnwp' ),
   ...
   register_sidebar( array(
      'name'          => esc_html__( 'Footer Sidebar 3', 'learnwp' ),
  ...
  register_sidebar( array(
    'name'            => esc_html__( 'Sidebar Shop', 'learnwp' ),
    'id'              => 'learn-wp-sidebar-shop',
    'description'     => esc_html__( 'Drag and drop your WooCommerce widgets here', 'learnwp' ),
    'before_widget'   => '<div id="%1$s" class="widget %2$s widget-wrapper">', 
    'after_widget'    => '</div>',
    'before_title'    => '<h4 class="widget-title">',
    'after_title'     => '</h4>',
