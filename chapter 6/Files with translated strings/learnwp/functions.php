...
function learnwp_config(){
   register_nav_menus(
      array(
        'learnwp_main_menu'   => __( 'Learn WP Main Menu', 'learnwp' ),
        'learnwp_footer_menu' => __( 'Learn WP Footer Menu', 'learnwp' ),
      )
   );	
...
function learnwp_sidebars(){
   register_sidebar( array(
      'name'          => __( 'Learn WP Main Sidebar', 'learnwp' ),
      'id'            => 'learn-wp-sidebar-1',
      'description'   => __( 'Drag and drop your widgets here', 'learnwp' ),
   ...
   register_sidebar( array(
      'name'          => __( 'Footer Sidebar 1', 'learnwp' ),
   ...
   register_sidebar( array(
      'name'          => __( 'Footer Sidebar 2', 'learnwp' ),
   ...
   register_sidebar( array(
      'name'          => __( 'Footer Sidebar 3', 'learnwp' ),
  ...
  register_sidebar( array(
    'name'            => __( 'Sidebar Shop', 'learnwp' ),
    'id'              => 'learn-wp-sidebar-shop',
    'description'     => __( 'Drag and drop your WooCommerce widgets here', 'learnwp' ),
    'before_widget'   => '<div id="%1$s" class="widget %2$s widget-wrapper">', 
    'after_widget'    => '</div>',
    'before_title'    => '<h4 class="widget-title">',
    'after_title'     => '</h4>',
