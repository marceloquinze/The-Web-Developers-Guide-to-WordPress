                     ...
                     <div class="account-menu">
                        <div class="navbar-expand">
                           <ul class="navbar-nav float-left">
                              ...
                              ?>
                              <li>
                                 <a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>" class="nav-link"><?php _e( 'My Account', 'learnwp' ); ?></a>
                              </li>
                              <li>
                                 <a href="<?php echo wp_logout_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>" class="nav-link"><?php _e( 'Logout', 'learnwp' ); ?></a>
                              </li>
                              <?php 
                              ...
                              ?>
                              <li>
                                 <a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>" class="nav-link"><?php _e( 'Login / Register', 'learnwp' ); ?></a>
                              </li>                                    
                              <?php endif; ?>
                           </ul>
                        </div>                        
