         ...
         <main>
            ...
            ?>            
               <section class="popular-products">
                  ...
                  <div class="container">
                     <div class="section-title">
                        <h2><?php echo get_theme_mod( 'set_popular_title', __( 'Popular products', 'learnwp' ) ); ?></h2>
                     </div>
               ...
               <section class="new-arrivals">
                  <div class="container">
                     <div class="section-title">
                        <h2><?php echo get_theme_mod( 'set_new_arrivals_title', __( 'New Arrivals', 'learnwp' ) ); ?></h2>
                     </div>
               ...
               <section class="deal-of-the-week">
                  <div class="container">
                     <div class="section-title">
                        <h2><?php echo get_theme_mod( 'set_deal_title', __( 'Deal of the Week', 'learnwp' ) ); ?></h2>
                     </div>               
                     <div class="row d-flex align-items-center">
                        ...
                        <div class="deal-desc col-md-4 col-12 mr-auto text-center">
                           <?php if( !empty( $sale ) ): ?>
                              <span class="discount">
                                 <?php echo $discount_percentage . __( '% OFF', 'learnwp' ); ?>
                              </span>
                           <?php endif; ?>
                           <h3>
                           ...
                           <a href="<?php echo '?add-to-cart=' . $deal; ?>" class="add-to-cart"><?php _e( 'Add to Cart', 'learnwp' ); ?></a>
                        </div>
                     </div>
                  </div>
               </section>
            ...
            <section class="site-blog">
               <div class="container">
                  <div class="section-title">
                     <h2><?php echo get_theme_mod( 'set_blog_title', __( 'Latest News', 'learnwp' ) ); ?></h2>
                  </div>
                  <div class="row">
                     <?php
                     ...
                     ?>
                        <p><?php _e( 'Nothing to display.', 'learnwp' ); ?></p>
                     <?php endif; ?>
                  </div>
               </div>                                   
            </section>
