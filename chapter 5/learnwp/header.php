                     ...
                     <div class="account-menu">
                        <div class="navbar-expand">
                           <ul class="navbar-nav float-left">
                              ...
                              ?>
                              <li>
                                 <a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>" class="nav-link">My Account</a>
                              </li>
                              <li>
                                 <a href="<?php echo wp_logout_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>" class="nav-link">Logout</a>
                              </li>
                              <?php 
                              ...
                              ?>
                              <li>
                                 <a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>" class="nav-link">Login / Register</a>
                              </li>                                    
                              <?php endif; ?>
                           </ul>
                        </div>                        
